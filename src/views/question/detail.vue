<template xmlns:el-col="http://www.w3.org/1999/html">
  <div v-loading="qLoading" style="line-height:1.8" class="questionDiv">
    <div v-if="qType===1||qType===2||qType===3||qType===4||qType===5">
      ...
      <div v-else-if="qType===5">
        <div class="q-title" v-html="question.title" />
        <div>
          <el-input v-model="answer.content" type="textarea" rows="5" :disabled="true" />
        </div>
      </div>
...
<script>
import { selectQuestionAnswer } from '@/api/question'
...
export default {
  ...
  methods: {
    getQuestionAnswer() {
      ...
      selectQuestionAnswer(id).then(re => {
        this.question = re.data.question
        this.qType = re.data.question.questionType
        this.answer = re.data.questionAnswer
      })
      this.qLoading = false
    },
